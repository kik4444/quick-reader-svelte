...
pub fn Textarea(
    ...
    #[prop(optional, into)] class_textarea: Option<MaybeSignal<String>>,
    #[prop(optional, into)] class_label: Option<MaybeSignal<String>>,
        ...
        <div class="relative w-full min-w-[200px]">
          <textarea
            ...
            class=move || {
                format!(
                    ...
                    class_textarea.as_ref().map(| c | c()).unwrap_or_default()
                )
            }
          ...
          <label class=move || {
              format!(
                  ...
                  class_label.as_ref().map(| c | c()).unwrap_or_default()
              )
          }>{label}</label>
        </div>
      </div>
